        ...
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Mantenimiento Roles</h3>
                </div>
                <div class="row">
                            ...
                            <div class="modal fade" id="editar<?=$i?>" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" id="form" action="<?=base_url?>roles/editar">
                                                <div class="row">
                                                    <div class="col-md-8 m-auto">
                                                        <label for="usuario">Rol</label>
                                                        <input required type="text" id="rol" name="rol"
                            ...
                            <div class="modal fade" id="eliminar<?=$i?>" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?=base_url?>roles/eliminar" method="post">
                                                <div class="row">
                                                    <div class="col-md-10 m-auto">
                                                        <h5 class="modal-title text-center">¿Estas seguro de que quieres
                                                            eliminar este registro del rol "<span
                                                                class="font-italic"><?php echo $row['rol']; ?></span>" ?
                                                        </h5>

                                                        <input type="hidden" class="form-control" id="rol" name="rol"
                                                            value="<?php echo $row['id_rol']; ?>"
                                                            placeholder="<?php echo $row['id_rol']; ?>">
                                                    </div>
                                                </div>
...
<div class="modal fade" id="registrorol" tabindex="-1" role="dialog" aria-labelledby="registrorolLabel"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="form" action="<?=base_url?>roles/guardar">
                    <div class="row">
                        <div class="col-md-8 m-auto">
                            <label for="usuario">Rol</label>
                            <input required type="text" id="rol" name="rol" class="form-control" placeholder="Rol">
                        </div>
                    </div>
                    <div class="row mt-5">
                        <div class="col-md-9 m-auto">
