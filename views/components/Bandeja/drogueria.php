                ...
                <div class="card-body p-3 border">
                    <ul class="nav nav-pills flex-column nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item  bg-secondary">
                            <a href="<?=base_url?>bandeja/drogueria" class="nav-link text-white">
                                AUTORIZADO POR LA DROGUERIA <span
                                    class="float-right badge badge-light"><?php echo $total['AuthDrog'];?></span>
                            </a>
                        </li>
                        <li class="nav-item ">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <h3 class="text-header font-weight-bold">Autorizados por la drogueria hasta la fecha <span
