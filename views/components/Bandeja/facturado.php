                ...
                <div class="card-body p-3 border">
                    <ul class="nav nav-pills flex-column nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item ">
                            <a href="<?=base_url?>bandeja/laboratorio" class="nav-link text-dark">
                                AUTORIZADO POR EL LABORATORIO<span
                                    class="float-right badge badge-secondary"><?php echo $total['AuthLab'];?></span>
                            </a>
                        </li>
                        <li class="nav-item  ">
                        ...
                        <li class="nav-item bg-secondary">
                            <a href="<?=base_url?>bandeja/facturacion" class="nav-link text-white">
                                FACTURADO<span
                                    class="float-right badge badge-light"><?php echo $total['Facturado'];?></span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <h3 class="text-header font-weight-bold">Facturado hasta la fecha <span class="text-success"><i
